  ...
  const [team, setTeam] = useLocalStorage("bca_team", [
    {
      ...
      email: "sarah@bca.edu",
      avatar: "https://ui-avatars.com/api/?background=3b82f6&color=fff&name=SJ",
    },
    {
      id: uuidv4(),
      name: "Michael Chen",
      role: "President",
      email: "michael@bca.edu",
      avatar: "https://ui-avatars.com/api/?background=8b5cf6&color=fff&name=MC",
    },
  ]);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Add or manage executive committee members
          </p>
        </div>
        <motion.button
            ...
            <form onSubmit={handleAdd} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input
                  ...
                  className="px-4 py-2 rounded-xl border border-slate-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 outline-none transition"
                />
                <input
                  type="text"
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 flex items-center gap-2"
                >
