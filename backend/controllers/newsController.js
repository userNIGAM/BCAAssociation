...
export const incrementNewsView = asyncHandler(async (req, res) => {
...
export const createNews = asyncHandler(async (req, res) => {
  ...
  if (req.file) {
    try {
      const uploaded = await uploadToCloudinary(req.file.buffer, "news");
...
export const updateNews = asyncHandler(async (req, res) => {
  ...
  news.image = imageUrl;
  news.isPublished = req.body.isPublished === "true" || req.body.isPublished === true;
